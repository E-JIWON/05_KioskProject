            ...
            $.each(value_1, function(index_2, value_2){
                    if(index_2 == "name"){
                        if(tempArray[tempCount] == undefined){
                            temp_list_op.push("");
                            option_name_temp.push("");
                        }else {
                            let tempStr = String(tempArray[tempCount].innerHTML).split("<");
                            let opPriceStr = String(tempStr[3]).split(">"); 
                            op_price_temp = opPriceStr[1]; 
                            value_1[index_2] = tempStr[0]; 
                            temp_list_op.push(tempStr[0]);
                            option_name_temp.push(tempStr[0]);
                        }
                        ...
                        if(tempArray[tempCount] == undefined){
                            ...
                            opSumPrice += get_number_func(op_price_temp); 
                        }
                    }
            });
            tempCount++;
